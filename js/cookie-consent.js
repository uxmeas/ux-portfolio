...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      // Per-variant borders below; base .cc-btn stays borderless so primary
      // (solid) and outline (ghost) variants control their own weight.
      '.cc-btn{' +
        'height:var(--cc-btn-height);padding:var(--cc-btn-padding);' +
        'font-size:var(--cc-font-base);font-weight:var(--cc-font-weight-bold);' +
        'border-radius:var(--cc-radius-pill);border:1px solid transparent;' +
        'cursor:pointer;white-space:nowrap;font-family:var(--cc-font);' +
        'display:inline-flex;align-items:center;justify-content:center;' +
        'transition:background .15s,color .15s,border-color .15s;' +
        'line-height:1;text-decoration:none' +
      '}',
      '.cc-btn-primary{background:var(--cc-text);color:var(--cc-bg);border-color:var(--cc-text)}',
      '.cc-btn-primary:hover{background:#e5e5e5;border-color:#e5e5e5}',
      '.cc-btn-secondary{background:var(--cc-text);color:var(--cc-bg);border-color:var(--cc-text)}',
      '.cc-btn-secondary:hover{background:#e5e5e5;border-color:#e5e5e5}',
      '.cc-btn-outline{background:transparent;color:var(--cc-text);border-color:var(--cc-border-strong)}',
